...
# todo 这里需要重命名导入
# 原始 --> mport hello_pb2 as hello__pb2
from basic_learning.server import hello_pb2 as hello__pb2
...
def add_HelloServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'server.HelloService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('server.HelloService', rpc_method_handlers)
